...
ALTER TABLE IF EXISTS USER_PV ADD COLUMN PV_HEADQUARTER_REDE_ID BIGINT;
ALTER TABLE IF EXISTS USER_PV ADD CONSTRAINT FK_PV_HEADQUARTER_REDE FOREIGN KEY (PV_HEADQUARTER_REDE_ID) REFERENCES PV (ID);
...
INSERT INTO PV (ID, CODE, ACQUIRER_ID) VALUES (5, '0052345678', 2);
INSERT INTO PV (ID, CODE, ACQUIRER_ID) VALUES (6, '0092315670', 2);
